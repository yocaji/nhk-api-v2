...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NhkApiV2.DescriptionList();
  });
  ...
  describe('DescriptionList', function() {
    it('should create an instance of DescriptionList', function() {
      // uncomment below and update the code to test DescriptionList
      //var instance = new NhkApiV2.DescriptionList();
      //expect(instance).to.be.a(NhkApiV2.DescriptionList);
    });
