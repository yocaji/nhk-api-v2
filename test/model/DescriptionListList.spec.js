...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NhkApiV2.DescriptionListList();
  });
  ...
  describe('DescriptionListList', function() {
    it('should create an instance of DescriptionListList', function() {
      // uncomment below and update the code to test DescriptionListList
      //var instance = new NhkApiV2.DescriptionListList();
      //expect(instance).to.be.a(NhkApiV2.DescriptionListList);
    });
