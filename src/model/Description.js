...
class Description {
     ...
     */
    constructor(id, eventId, startTime, endTime, area, service, title, subtitle, content, act, genres, programLogo, hashtags) { 
     ...
     */
    static initialize(obj, id, eventId, startTime, endTime, area, service, title, subtitle, content, act, genres, programLogo, hashtags) { 
        obj['id'] = id;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('program_logo')) {
                obj['program_logo'] = Logo.constructFromObject(data['program_logo']);
            }
            if (data.hasOwnProperty('program_url')) {
                obj['program_url'] = ApiClient.convertToType(data['program_url'], 'String');
            }
            if (data.hasOwnProperty('hashtags')) {
                obj['hashtags'] = ApiClient.convertToType(data['hashtags'], ['String']);
            }
            if (data.hasOwnProperty('extras')) {
                obj['extras'] = Extra.constructFromObject(data['extras']);
            }
        }
        return obj;
    }
