...
var ApiClient = /*#__PURE__*/function () {
   ...
   */
  function ApiClient() {
    var basePath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'https://api.nhk.or.jp/v2/pg';
     ...
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
     * @default https://api.nhk.or.jp/v2/pg
     */
    ...
    this.defaultHeaders = {
      'User-Agent': 'OpenAPI-Generator/1.1.15/Javascript'
    };
    /**
